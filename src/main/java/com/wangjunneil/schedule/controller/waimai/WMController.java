...
//    @Autowired
//    private EleMeApiService ee;
//    @RequestMapping(value = "/elemetext.php",method = RequestMethod.GET)
//    public String text(PrintWriter out, HttpServletRequest req) throws ScheduleException {
//        //测试用
////        String returnJson = eleMeFacadeService.getHistoryOrder();
////        out.println(returnJson);
////        out.close();
//        ArrayList<ParsFromPosInner> parsFromPosInners = new ArrayList<ParsFromPosInner>();
//        ParsFromPosInner parsFromPosInne1 = new ParsFromPosInner();
//        parsFromPosInne1.setDishId("987654321");
//        parsFromPosInners.add(parsFromPosInne1);
//
//        System.out.println(eleMeFacadeService.deleteFoods(parsFromPosInners));
//        return null;
//    }
}
