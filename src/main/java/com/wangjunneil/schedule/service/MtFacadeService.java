...
public class MtFacadeService {
    ...
    //门店开业
    private static final String OPEN_SHOP_URL = "http://waimaiopen.meituan.com/api/v1/poi/open";
    ...
    //推送已支付订单
    private static final String ORDER_PAYFINISH_URL = "http://waimaiopen.meituan.com/api/v1/poi/mget";
